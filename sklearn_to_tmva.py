...
def gbr_to_tmva(cls, data, outfile_name, **kwargs):
	...
	feature_names = kwargs.get("var_names", ['none'])
	features_min = [data[:,fn].min() for fn in range(len(feature_names))]
	features_max = [data[:,fn].max() for fn in range(len(feature_names))]
...
<MethodSetup Method="BDT::{mva_name}">
	<GeneralInfo>
		...
		<Info name="Creator" value="kderoove"/>
		<Info name="Date" value="Sun May 31 01:31:49 2015"/>
		<Info name="Host" value="Linux cmsdev02.cern.ch 2.6.32-431.11.2.el6.x86_64 #1 SMP Wed Mar 26 09:39:43 CET 2014 x86_64 x86_64 x86_64 GNU/Linux"/>
		<Info name="Dir" value="/user_mnt/user/kderoove/bTagging/MoveCSVv2ToMVApackage/CMSSW_7_4_14/src/RecoBTag/ScikitLearn/VotingClassifier"/>
    	<Info name="Training events" value="1692351"/>
    	<Info name="TrainingTime" value="435.19"/>
